...
<nav class="colorCustom darken-3 nav-extended">
    <div class="nav-wrapper">
        <ul class="tabs tabs-transparent">
            ...
            <li class="tab"><a href="#experiences">Experiences/Projet</a></li>
            ...
            <div id="experiences" class="col s12">
                <h3>Experiences/Projet</h3>
                <div>
                    <ul class="collapsible" data-collapsible="accordion">
                        <li>
                            <div class="collapsible-header">Hour of code<a class="right" href="https://hourofcode.com/fr" target="_blank">Site web</a></div>
                            <div class="collapsible-body"><p>Initiation au code avec 5 classe de troisiéme au collége jean racine à Alés</p><img src="Ressource/dev/hoc-photo.jpg"></div>

                        </li>
                        <li>
                            <div class="collapsible-header">Yummy<a class="right" href="https://coda-projet-kitchen.github.io/prototype1/" target="_blank">Preview de l'application</a></div>
                            <div class="collapsible-body"><p>Projet d'application pour les cuisine de l'AFPA d'Alés<br>avec Nabil Ghedjati et Samir Ben Sadi</p></div>
                        </li>
                    </ul>
                </div>
            </div>
            <div id="formation" class="col s12">
                <h3>Formation</h3>
                <a href="http://simplon.co/" target="_blank"><h4>Simplon</h4></a>
